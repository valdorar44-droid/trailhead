...
export const MAP_LEGEND_CATEGORIES: readonly MapLegendCategory[] = [
  {
    ...
    color: '#14b8a6',
    source: 'Camp cards show stay type, access notes, and recent checks when available.',
    items: [
  ...
  },
  {
    ...
    color: '#22c55e',
    source: 'Trail lines are for planning. Check posted signs and current conditions before committing.',
    items: [
  ...
  },
  {
    ...
    color: '#f97316',
    source: 'Motor access can change by season or closure. Check posted signs before committing.',
    items: [
  ...
  },
  {
    ...
    icon: 'people-outline',
    color: '#38bdf8',
    source: 'Reports are most useful when recently confirmed.',
    items: [
  ...
  },
  {
    ...
    color: '#f59e0b',
    source: 'Weather and fire conditions can change quickly, especially in sparse regions.',
    items: [
  ...
  },
  {
    ...
    icon: 'boat-outline',
    color: '#0891b2',
    source: 'Water details are for planning. Use current charts and local markers on the water.',
    items: [
  ...
  },
  {
    ...
    color: '#94a3b8',
    source: 'Place cards combine land-manager guidance, current notes, and community reports.',
    items: [
      ...
      { label: 'Needs check', detail: 'Details are limited or older.', color: '#f59e0b', glyph: 'icon', icon: 'alert-circle-outline' },
