...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Open the map menu, then Search for towns, fuel, trailheads, camps, and places along the way.',
    target: 'MAP MENU',
  ...
  },
  {
    ...
    body: 'The map menu keeps search, camps, pins, weather, layers, filters, offline maps, and trail building together.',
    target: 'MAP MENU',
    targetKind: 'mapLayers',
    targetKey: 'map.tools',
  },
  {
    ...
    body: 'Open the map menu, choose Search, then Trails in this view for nearby trailheads and trail places.',
    target: 'MAP MENU',
  ...
  },
  {
    ...
    body: 'Open the map menu, then Trail builder. Drop points along a trail, preview the route, then save or follow.',
    target: 'MAP MENU',
  ...
  },
  {
    ...
    body: 'Open the map menu, then Offline before leaving coverage.',
    target: 'MAP MENU',
  ...
  },
  {
    ...
    body: 'Open the map menu, then Add pin for places worth keeping. Use Report for hazards, closures, and current trail conditions.',
    target: 'MAP MENU',
    targetKind: 'mapLayers',
    targetKey: 'map.tools',
  },
