...
## S4U Foothills script and original-artwork approval closeout

- Completed: 2026-08-10 local time. The authoritative approval event is `2026-08-11T03:09:33.129Z`.
- Release branch: `release/smokies-s4m-production-20260810`.
- Guarded source commit: `bc70fae8a8dad021818d07df5d517c556d133968`; tree: `f468715d53cd23cca1e79162c7b163059560f13b`; parent: `b501dedcb381705a8c84328650f1bfc5db6afc19`. The source commit was clean, pushed, and origin-equal before this checkpoint was written.
- In task `019fe9fb-cafa-75d3-b663-1e5051731cd5`, the project owner answered the immediately preceding exact review gate with `approved`. The recorded nine-byte UTF-8 message includes its trailing newline and has SHA-256 `7f8518f7db5e9a55049f49c4ea6d6e8f509695231e60cbd607bcb36c88a75a14`. The decision is normalized only as approval of all exact items presented in that gate; the longer requested decision phrase is not attributed to the owner.
- The immutable approval overlay is `originals/smokies/foothills_parkway_approval_v1.json`, 13,151 bytes, SHA-256 `a301c702155512c66df60e819274271fc9a6001b398266be5d9a6329a82592bb`. It binds all thirteen exact Foothills scripts in order: six stories, seven cues, and the three reviewed east-to-west cue overrides. It records exact transcript hashes without embedding transcript text.
- The same decision approves both exact original artwork candidates for the reviewed Foothills uses: `media_fp_panorama`, 2,067,676 bytes, SHA-256 `92da599e63f7f2afabd81106d6649441b11b5406e7c94ec3ba448c643e6f19d8`; and `media_fp_engineering`, 1,650,379 bytes, SHA-256 `ed4f3bc69b7fd0f34040e3214a1633f410327c0deb3c0c04412d861760de78af`. Their source, public-domain basis, intended use, credit, and `No claim to original U.S. Government works.` notice remain bound exactly.
- The artwork approval applies to the immutable originals only. The panorama still contains GPS and device EXIF; the engineering image still contains device/date EXIF. Neither is sanitized, derivative-approved, or ingestion-safe at this checkpoint.
- The review packet remains byte-identical at 55,719 bytes and SHA-256 `7a3217f0dc11c503f43ca12d82b339d5537de6365441f607eacfd7c3945ea926`. The rendered review sheet remains byte-identical at 30,948 bytes and SHA-256 `aef724ffa60792be57d2efeed3668c32127518787119f31b44243f211620d240`. Both identities were verified at source commit `7b37de90f8df9a5f9a04e6fda0a6fc276d4e3cd5` and review checkpoint `b501dedcb381705a8c84328650f1bfc5db6afc19`; neither historical review record was rewritten to manufacture approval.
- The deterministic, network-free, database-free builder is 17,473 bytes with SHA-256 `e3ad61262d3b23fa6fe2eb0d891131b6f94720ff24389c01e4221b5316bff41f`. Its focused test is 9,808 bytes with SHA-256 `1f34b93f7567926681e7d46ee720669c675ed822040a30b124c18e2038468827`.
- Root verification passed forty-three approval/review/cultural/readiness checks, deterministic regeneration, Python compilation, privacy checks, and repository whitespace validation. Independent verification passed sixty-one focused checks and 316 broader Smokies checks, with four expected skips and four subtests; the final P0/P1 verdict was GO with no release overclaim.
- The product contract remains one four-chapter Smokies Original: Mountain Crossing, Little River / Cades Cove, Roaring Fork, and Foothills Parkway; Explorer access is included; permanent ownership costs 900 earned credits; no standalone chapter is approved. The accepted Roaring Fork manifest, profile, assets, preview evidence, and trusted report remain unchanged.
- This approval does not authorize another chapter, image sanitation, derivative generation, derivative visual approval, narrator selection, TTS/rendering, narration generation, ingestion, upload, manifest creation or mutation, database access, deployment, trusted validation, or publication. No EBCI or other external outreach is needed or authorized for the exact checked public-record claim set, and no cultural-scope record changed.
- Gate state at this checkpoint: `foothills_exact_scripts_user_approved=true`; `foothills_exact_original_artwork_user_approved=true`; `artwork_sanitation_authorized=false`; `artwork_derivatives_created=false`; `derivative_visual_approval=false`; `foothills_narrator_approved=false`; `tts_or_render_authorized=false`; `narration_generated=false`; `ingestion_allowed=false`; `manifest_creation_or_mutation_allowed=false`; `upload_allowed=false`; `production_mutation_allowed=false`; `publication_allowed=false`; `public_release=false`; `other_chapters_approved=false`.

### Exact next actions after S4U

1. Stop at this gate. If desired, separately authorize deterministic metadata-stripped derivatives of the two exact approved originals; creating those derivatives still would not approve them for ingestion.
2. Review and explicitly approve the exact derivative bytes in a later visual gate before any ingestion or manifest binding.
3. Separately select and authorize a hash-bound, budget-capped Foothills narrator render. Script approval alone does not authorize TTS or spend provider credits.

### Do not repeat after S4U

- Do not rewrite the Foothills review packet, review sheet, source scripts, approval overlay, public-record determination, readiness V1/V2/V3, or accepted Roaring Fork evidence while their identities remain unchanged.
- Do not reinterpret `approved` as authorization for sanitation, derivatives, narration, ingestion, manifests, upload, deployment, validation, or publication.
- Do not contact EBCI, create culturally gated content, process the approved originals, render narration, begin another chapter, or mutate production without the corresponding separate authorization.

## S4V Remaining-chapter combined review and James preflight gate

- Completed: 2026-08-10 local time.
- Release branch: `release/smokies-s4m-production-20260810`.
- Guarded source commit: `6cb0d4f480260e1789add4474054abd80be8c62c`; tree: `81e37635ace9c12b6334af6bad448c596f2e86e1`; parent: `30305634e26ddf420062497786783c1b2eab9ba7`. The source commit was clean, pushed, and origin-equal before this checkpoint was written.
- The project owner selected the full-bundle execution direction: batch the remaining chapters, use James throughout, present Mountain Crossing and Cades Cove in one combined review, use representative owner listening plus automated QA on every file, require compatible Android and iOS builds before public release, and reserve publication for a separate single-use same-owner gate. These choices select the review and narrator direction only; they do not authorize provider spend, image processing, media generation, ingestion, deployment, validation, or publication.
- The deterministic combined packet is `originals/smokies/remaining_chapters_review_packet_v1.json`, 262,825 bytes, SHA-256 `3ef71377c9e347cd53335cbf487d039ff973b8c28f9628b622fcee74c714b015`. The rendered owner sheet is `docs/originals/mountain-crossing-cades-cove-review-sheet-v1.md`, 146,225 bytes, SHA-256 `bb7665770d0f651be4b6b961f6a1a8de2f9b94b1c6edf18a457c2fafd02752ce`.
- The review set contains exactly fifty-one source-locked scripts: Mountain Crossing has eighteen stories and ten cues; Little River / Cades Cove has fourteen stories and nine cues. It separately exposes five exact Mountain Crossing `nc_to_tn` cue replacements for `mc_cue_01`, `mc_cue_02`, `mc_cue_04`, `mc_cue_08`, and `mc_cue_09`. None of those scripts, replacements, or their rendering is approved by this checkpoint.
- Four exact original-artwork decisions are pending: `media_mc_kuwohi`, 2,524,538 bytes, SHA-256 `023e027f74aff09bacbec01e89c144248cf3e633f33faa0413e41518d7157c02`; `media_mc_oconaluftee`, 3,782,011 bytes, SHA-256 `33a44dea4f933f68af8d6e9cc70aaf68ede2ef418f675b87ef3d51cfd8bc21c5`; `media_cc_cove`, 19,782,736 bytes, SHA-256 `c01e63f283a7b8b63d721792172ffcc772c168a4f6e32c788e9f4344308de476`; and `media_cc_cable_mill`, 18,057,520 bytes, SHA-256 `6b9d41b9ce8599d17fe94d478866d2d0384d6f0b8dd005ee5183e41abe5549cd`.
- The six-image sanitation proposal covers those four originals plus the two S4U-approved Foothills originals. It is a specification only: full selected frame, no crop or resize, deterministic sRGB output, RGB PNG, and only `IHDR`, `IDAT`, and `IEND` chunks. The Kuwohi source is correctly bound as a two-frame MPO whose later derivative would select primary frame 0 without merging or retaining frame 1. The two Cades sources are untagged grayscale TIFFs whose later RGB conversion would use exact equal-channel replication. `sanitation_authorized=false`; no derivative exists.
- Both configured evidence roots contain all six originals and match every recorded byte count, SHA-256, format, dimensions, frame count, selected-frame pixel hash, ICC fact, and redacted EXIF-presence fact. The tracked packet contains logical locators only; it serializes no absolute path, username, raw GPS value, device value, credential, or binary.
- The network-free James locks preserve the accepted voice `EkK5I93UQWFDigLMpZcX`, model `eleven_multilingual_v2`, provider-native mono `mp3_44100_128`, stability `0.5`, similarity `0.5`, style `0.1`, speaker boost enabled, and speed `1.0`. Render, provider request, key creation, paid overage, and spend authorization remain false.
- Foothills lock: 16 requests, 21,408 payload characters, 21,369 normalized characters, 23,557 reserved credits, 23,600 renderer cap, 25,000 proposed one-day key quota, and `$2.50` hard dollar cap. Artifact: 33,701 bytes, SHA-256 `eac2d636c4c26fd55fbc4ebe7b7be25882ffd51e6064703924d96d89fa71c119`.
- Mountain Crossing lock: 33 requests, 59,928 payload characters, 59,801 normalized characters, 65,938 reserved credits, 66,000 renderer cap, 70,000 proposed one-day key quota, and `$7.00` hard dollar cap. Artifact: 63,724 bytes, SHA-256 `561a8a8bf62f534d485df0ebf523d13a9defd962af136240fd46e1ca5aacec25`.
- Little River / Cades Cove lock: 23 requests, 44,259 payload characters, 44,158 normalized characters, 48,695 reserved credits, 48,700 renderer cap, 50,000 proposed one-day key quota, and `$5.00` hard dollar cap. Artifact: 44,518 bytes, SHA-256 `6c6fecdaa85d91f4e29cd08ea9c46f20d404dba8ed72962390b8d8d8dc5b6a04`.
- The combined preflight covers exactly seventy-two unique requests: sixty-four base entries plus eight directional replacements. Totals are 125,595 payload characters, 125,328 normalized characters, 138,190 reserved credits, 138,300 isolated renderer caps, 145,000 proposed one-day key quotas, zero rerender budget, no cross-chapter borrowing, no paid overage, and a `$14.50` aggregate hard ceiling. The preflight is 10,917 bytes with SHA-256 `e396aff7b495f087838cfb284a5d9e6a7ac43c9b873550e2a71a5527a41379b4`.
- The review builder is 91,198 bytes with SHA-256 `ec02c83efdd658a1d618cd33fd4a5a69280f482d19ad1ab6d0e608d977e19307`; its focused test is 26,953 bytes with SHA-256 `b86209dc114220a981209b5f11467ecc4579e709245479ccc571bcfc6ee19fd2`. The James-lock builder is 48,194 bytes with SHA-256 `44bbddf60383d6a5f3a6fcf7e2bbe4b6aad824c8397d93e093818c1b5d49d354`; its focused test is 20,207 bytes with SHA-256 `914bf2f3a0636208d0d3d5b6d35cc50fce4c17b08f9a1ad0bc4bd90a11b4fd62`.
- Root verification passed thirty-nine new focused checks and 102 relevant Smokies regressions. Independent verification passed 355 broader Smokies/cultural checks, with four expected external-evidence skips and four subtests. Both builders reproduced exact bytes; two-mirror verification, Python compilation, privacy/format checks, source-drift failures, and repository whitespace checks were green. The final P0/P1 verdict was GO.
- The four-chapter, 900-earned-credit, Explorer-included, no-standalone product contract is unchanged. Roaring Fork's accepted bytes and evidence and Foothills S4U approvals remain hash-bound and unchanged. No EBCI or other external outreach is required or authorized for the exact public-record claim set.
- Gate state: `narrator_selected_for_remaining_chapters=true`; `remaining_script_decisions_recorded=false`; `remaining_override_decisions_recorded=false`; `remaining_artwork_original_decisions_recorded=false`; `six_image_sanitation_authorized=false`; `artwork_derivatives_created=false`; `provider_spend_authorized=false`; `one_day_provider_keys_created=false`; `tts_or_render_authorized=false`; `narration_generated=false`; `ingestion_allowed=false`; `upload_allowed=false`; `database_accessed=false`; `manifest_creation_or_mutation_allowed=false`; `production_mutation_allowed=false`; `trusted_validation_allowed=false`; `publication_allowed=false`; `public_release=false`.

### Exact next owner decision after S4V

1. Review the fifty-one scripts, five Mountain direction replacements, and four exact originals in `docs/originals/mountain-crossing-cades-cove-review-sheet-v1.md`.
2. Explicitly approve or revise those exact items; separately authorize or revise the six-image sanitation specification; and separately authorize or revise the exact James envelopes totaling seventy-two requests, 138,190 reserved credits, isolated caps, zero rerenders, no paid overage, and `$14.50` maximum.
3. After an exact affirmative decision, record it in a separate immutable approval overlay before creating a derivative, provider key, or narration file. Stop again after generated media QA for exact derivative/audio acceptance.

### Do not repeat after S4V

- Do not rewrite the editorial source files, S4U approval, public-record determination, readiness V1/V2/V3, accepted Roaring Fork evidence, or these review/lock artifacts while their identities remain unchanged.
- Do not treat the owner's planning choice of James as provider-spend or rendering authorization.
- Do not process an image, create a provider key, call ElevenLabs, spend credits, render narration, ingest or upload media, mutate a manifest or database, deploy, validate, publish, contact EBCI, or create culturally gated material before the corresponding explicit decision.

## S4W Checkpoint 2 media sanitation and provider-credit HOLD

- Completed: 2026-08-11 local time. The authoritative owner-approval event is `2026-08-11T04:27:57.463Z`.
- Release branch: `release/smokies-s4m-production-20260810`.
- Guarded source commit: `3a9e883eddcd5ae9ceef2297f2301f2ad87ea846`; tree: `1e092b2d69c0d86e1985a2f7e858027a9e9366cc`; parent: `c6193547336b30105152843d8078b9407bc541d8`. The source worktree was clean and based on the pushed S4V checkpoint before this checkpoint was written.
- In task `019fe9fb-cafa-75d3-b663-1e5051731cd5`, the project owner approved all exact Checkpoint 1 review items and authorized the six-image sanitation job plus the exact seventy-two-request James batch, capped at 138,190 reserved credits and `$14.50`, with zero rerenders and no paid overage. The exact 181-byte UTF-8 message includes one trailing LF and has SHA-256 `f6a3e3bc71b2b76b5cf791f8fdf11c7084c9e02ce81e05f2d388e17f44569af3`.
- The immutable approval overlay is `originals/smokies/checkpoint2_owner_approval_v1.json`, 68,453 bytes, SHA-256 `3cc18dad4d1b6a80f2259e58cbe50fba3804096d0c00437eca9103e626078d5c`. It binds all fifty-one reviewed scripts, five Mountain direction replacements, four reviewed originals, all six sanitation specifications, and the isolated Foothills/Mountain/Cades James envelopes. It does not authorize cross-chapter borrowing, paid overage, rerendering, partial-batch fallback, upload, database mutation, deployment, validation, or publication.
- Six deterministic, full-frame RGB PNG derivatives were created outside Git in two byte-identical configured evidence mirrors. All use 8-bit RGB, preserve the selected source dimensions, contain only `IHDR`, `IDAT`, and `IEND`, and contain no GPS, EXIF, device, timestamp, ICC, text, or ancillary chunks. The tracked evidence is `originals/smokies/remaining_artwork_derivatives_v1.json`, 34,407 bytes, SHA-256 `bbe38024d4d798673e9cd9684d26cf4f2620baf63ef6c230335a836cc443918a`.
- Exact derivative identities:
  - `media_fp_panorama`: 4,032 by 3,024; 10,144,630 bytes; SHA-256 `75e7605dfd26db71a8fb1877c7195e8f1df18c41d1cc9342041c6f34d5dbaba1`; decoded-pixel SHA-256 `aefcc7e4e6fed1cb0c9b8bb93ade3fe9185f3399e8aa9bdd78c00f46ece2b3e6`.
  - `media_fp_engineering`: 4,320 by 3,240; 11,042,083 bytes; SHA-256 `f96f1e5143e116e042916ec3f40cd4120454bfa579e9782639c5b2b672271c5e`; decoded-pixel SHA-256 `6be15ca5db35336ee346160d312bf1bea55d1a6152a8aa9493cc845cee72798d`.
  - `media_mc_kuwohi`: 3,996 by 2,775; 9,018,850 bytes; SHA-256 `956fad4e641b7abe498908e70f0b108f6363fe833f640f6cc02583e1a5713b32`; decoded-pixel SHA-256 `7a66bec70f98e4bdcc83e9e0b45543902e2ee4a752bb6a6437fd2cf4d8931ba8`. Only MPO Baseline MP Primary Image frame 0 is present; frame 1 was verified and excluded.
  - `media_mc_oconaluftee`: 4,032 by 3,024; 12,711,812 bytes; SHA-256 `9dff31bfd0c3e4417b2a67685e5fa3cb67bba8605a3099eb377de197904afd13`; decoded-pixel SHA-256 `172d4a2f88f8363fd2e660ffc157ee9265a1fe55c6ae3d9f90a6599b8c08fdd1`.
  - `media_cc_cove`: 5,000 by 3,956; 12,819,811 bytes; SHA-256 `80a82ae8ee7353b46ec24105ab80b2e651cd38375f50d9d64a346d092a99652c`; decoded-pixel SHA-256 `f54d50976dc1c1b6b477c160b0193263b4bc451b3264324f0c5594cffe7f8232`.
  - `media_cc_cable_mill`: 5,000 by 3,611; 13,326,710 bytes; SHA-256 `3540935d92ae2d48a6b2ce15c37da653bd32ec371fb1249191625ce10addcd9b`; decoded-pixel SHA-256 `6df57c5b652b3ee7f53421c4bd35b87e90357d513296a6ebbc03431f2c551a71`.
- Tagged sources were converted to sRGB with the recorded LittleCMS contract; untagged RGB samples were preserved under the recorded sRGB assumption; both untagged grayscale TIFFs used exact equal-channel L-to-RGB replication. No crop or resize occurred. Exact source, rights, credit, change-note, attribution, and government-work-notice bindings are retained. The derivatives passed technical and manual sanity review, but project-owner derivative visual approval remains false pending the later media-acceptance checkpoint.
- A fresh signed-in ElevenLabs preflight confirmed the Creator/commercial account state, exact James voice `EkK5I93UQWFDigLMpZcX`, `eleven_multilingual_v2`, `mp3_44100_128`, exact requested settings, restricted one-day key capability, and the current non-EEA Terms/VLA/Prohibited Use/Beta Addendum tuple. The planned requests are explicitly non-Beta. No API key was created.
- The same preflight found 116,490 included credits remaining from 131,000 total after 14,510 used. The full locked reservations require 138,190, so the batch is short 21,700 credits; it is also 21,810 below the summed renderer caps and 28,510 below the proposed key quotas. Auto top-up is off and the top-up balance is `$0.00`. The signed-in UI displays renewal on September 8; year 2026 is inferred from the observation date rather than displayed by the provider.
- The redacted provider observation is `originals/smokies/elevenlabs_james_remaining_provider_observation_v1.json`, 4,431 bytes, SHA-256 `dfae2340fa82cb1d92e70e4d0af1d74f3e9666a72465ccbb51ec362b2b6c2e21`. The deterministic NO-GO record is `originals/smokies/elevenlabs_james_remaining_provider_preflight_v1.json`, 10,768 bytes, SHA-256 `d6deaffbd86cc7b17e241ade7a28a48f07063bbb55dba43907d016da02735eb8`.
- A one-time prepaid credit purchase is available, but no amount was selected or authorized. The approved `$14.50` renderer ceiling is not treated as authorization to buy credits or enable usage-based overage. Zero keys were created or deleted; zero TTS requests were sent; zero provider credits were spent; and no purchase, billing change, account change, upload, database access, production mutation, deployment, validation, or publication occurred.
- Root verification passed 128 combined Checkpoint 1/2 tests. Independent provider verification passed 131 tests. Independent derivative verification passed fourteen focused and eighty-two broad tests; the frozen full Smokies regression passed 416 checks with four expected external-evidence skips and four subtests. Deterministic generation, source-mirror equality, Python compilation, privacy scans, repository whitespace checks, and independent P0/P1 audits were green.
- Gate state: `remaining_review_items_user_approved=true`; `six_image_sanitation_authorized=true`; `artwork_derivatives_created=true`; `derivative_visual_approval=false`; `fresh_provider_preflight_complete=true`; `provider_credit_gate_passed=false`; `restricted_one_day_keys_created=0`; `tts_requests_sent=0`; `narration_generated=false`; `ingestion_allowed=false`; `upload_allowed=false`; `database_accessed=false`; `manifest_creation_or_mutation_allowed=false`; `production_mutation_allowed=false`; `trusted_validation_allowed=false`; `publication_allowed=false`; `public_release=false`.

### Exact next owner decision after S4W

1. Choose one credit path: wait for the visible September 8 renewal and run a fresh read-only preflight, or separately authorize a specific one-time prepaid credit purchase while keeping auto top-up and paid overage off. Partial rendering is not an approved workaround.
2. After sufficient included/prepaid credits exist, run a fresh exact account/terms/James/key preflight before creating any key. Then execute the seventy-two requests once through three sequential chapter-scoped keys and ledgers, preserving zero rerenders and no cross-chapter borrowing.
3. Stop again after automated audio QA. Present the six exact derivative hashes together with representative and flagged narration clips and exact usage for project-owner media acceptance.

### Do not repeat after S4W

- Do not regenerate the six derivative bytes while their exact source, toolchain, and hashes remain unchanged. Do not ingest or bind them into a manifest before their later exact visual approval.
- Do not create a provider key, render any chapter subset, enable auto top-up or paid overage, submit a prepaid purchase, or lower the reservation/cap contract merely to fit the current balance without a new exact owner decision and fresh preflight.
- Do not treat the current point-in-time provider observation as reusable after a credit, terms, voice, model, setting, or account change.
- Do not upload media, mutate the database or manifest, deploy, validate, publish, contact EBCI, or create culturally gated material in this HOLD checkpoint.
