...
ENTRIES = [
    ...
    _entry("mc_story_01", "mountain_crossing", 1, "story", "Where the crossing begins", "sugarlands", "The road leaves Sugarlands beside forest and moving water.", "Open with the watershed and orient the passenger to a cross-mountain journey.", ["mc_gateway_watershed"], directional=True),
    ...
    _entry("mc_story_16", "mountain_crossing", 16, "story", "Down to the Oconaluftee", "oconaluftee", "The road follows forest and river into a broader valley.", "Shift from high-country ecology to the Oconaluftee river-valley landscape.", ["mc_oconaluftee_valley"], directional=True),
    ...
    _entry("fp_cue_02", "foothills_parkway", 2, "cue", "First long view", "chilhowee_terminus", "The trees open to distant ridges.", "Invite the passenger to notice depth in the ridge sequence.", ["fp_geologic_view"], directional=True),
