...
class Settings:
    ...
    extreme_allowed_surfaces: str = os.environ.get("EXTREME_ALLOWED_SURFACES", "map,route_builder")
    ...
    extreme_copilot_enabled: bool = os.environ.get("EXTREME_COPILOT_ENABLED", "true").lower() in {"1", "true", "yes", "on"}
