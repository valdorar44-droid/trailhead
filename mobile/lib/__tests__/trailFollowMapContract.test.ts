...
assert.match(map, /trailRouteReviewCameraExperienceKey\(selectedTrail\?\.system_v2_id \?\? selectedTrail\?\.id\)/);
assert.doesNotMatch(map, /mapCameraExperienceKey = trailSelectionOwnsCamera[\s\S]{0,240}geometry_revision/);
