...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Search towns, gas, trailheads, destinations, camps, and trails from the top bar.',
  ...
  },
  {
    ...
    body: 'Safe Water, Trails, Filters, and Offline stay in the drawer alongside map styles.',
    target: 'TOOLS',
  ...
  },
  {
    ...
    body: 'Trail builder now lives in the tools drawer. Drop points along a trail, preview the route, then save or follow.',
    target: 'TOOLS',
  ...
  },
  {
    ...
    body: 'Open Offline from the tools drawer before leaving coverage.',
    target: 'TOOLS',
