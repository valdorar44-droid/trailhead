...
PROVIDER_REGISTRY: dict[str, ProviderMetadata] = {
    ...
    "geoapify": ProviderMetadata(
        id="geoapify",
        name="Geoapify Geocoding",
        source_type="commercial_open_data_host",
        update_cadence="live API",
        storage_rules="Store only the selected normalized destination needed for a saved route, with OpenStreetMap attribution.",
        attribution_text="OpenStreetMap contributors",
        license_url="https://www.geoapify.com/terms-and-conditions/",
        freshness_label="Live address and destination search",
        confidence_default=64,
        allowed_surfaces=("route_builder",),
        offline_allowed=False,
        derivative_constraints="Autocomplete suggestions are short-lived and coordinate-free. Persist only an explicitly selected, resolved destination and preserve OSM attribution.",
    ),
