...
function buildTrailheadStyle(layer: MapLayer, mapboxToken: string): any {
  ...
  layers.push(
    ...
    { id: 'trail-pack-casing', type: 'line', source: 'trailpacks', 'source-layer': 'trails', minzoom: 9, paint: { 'line-color': halo, 'line-width': ['interpolate', ['linear'], ['zoom'], 9, 2.1, 14, 6.2], 'line-opacity': 0.72 } },
    { id: 'trail-pack-line', type: 'line', source: 'trailpacks', 'source-layer': 'trails', minzoom: 9, paint: { 'line-color': ['match', ['coalesce', ['get', 'route_class'], ['get', 'kind'], 'trail'], 'mvum', '#22c55e', 'motorized', '#f97316', 'bike', '#38bdf8', '#7cbf74'], 'line-width': ['interpolate', ['linear'], ['zoom'], 9, 1.3, 14, 3.6], 'line-opacity': 0.9 } },
