...
const PAKISTAN_OFFICIAL_SEEDS: OfficialPlaceSeed[] = [
  ...
  },
  {
    ...
    highlight: 'Hushe is the practical base before drilling into Laila Peak, Masherbrum, and K7.',
  ...
  },
  {
    ...
    highlight: 'A findable Masherbrum trek area for Khaplu/Hushe route planning.',
  ...
  },
  {
    ...
    trails: [
      ...
      },
      {
        ...
        description: 'Good for an easier canyon day, sunset stops, or short segments between viewpoints and shuttle stops.',
...
const WATERFALLS: WaterfallSeed[] = [
  {
    ...
    highlight: 'A real Columbia River Gorge waterfall stop with bridge views, short walks, and permit-sensitive access.',
  },
  {
  ...
  },
  {
    ...
    highlight: 'A Great Lakes waterfall stop with easy viewpoints, forest trails, and useful campground context nearby.',
  },
  {
