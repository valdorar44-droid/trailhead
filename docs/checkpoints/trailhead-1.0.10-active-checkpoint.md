...
- Open P0: none. Pending assertion: tap the first park row once and confirm the stable NPS/park sheet. Do not repeat the ranking query.
- Exact next action: capture the already-visible first park sheet after the user taps the verified result, then continue the remaining focused iOS Plan/Downloads/Originals and background-audio/location delta.
