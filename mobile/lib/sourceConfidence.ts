...
const PROVIDER_DEFAULTS: Record<string, { name: string; type: 'official' | 'open' | 'community' | 'commercial' | 'first_party'; score: number; freshness: string }> = {
  nps: { name: 'National Park Service', type: 'official', score: 88, freshness: 'Official park guidance' },
  ridb: { name: 'RIDB / Recreation.gov', type: 'official', score: 86, freshness: 'Official recreation guidance' },
  'recreation.gov': { name: 'Recreation.gov', type: 'official', score: 86, freshness: 'Official recreation guidance' },
  usfs: { name: 'USFS', type: 'official', score: 84, freshness: 'Forest Service guidance' },
  blm: { name: 'BLM', type: 'official', score: 83, freshness: 'BLM guidance' },
  usgs: { name: 'USGS', type: 'official', score: 82, freshness: 'USGS guidance' },
  nws: { name: 'National Weather Service', type: 'official', score: 84, freshness: 'Official weather guidance' },
  airnow: { name: 'AirNow', type: 'official', score: 82, freshness: 'Official air quality guidance' },
  firms: { name: 'NASA FIRMS / WFIGS', type: 'official', score: 82, freshness: 'Official fire guidance' },
  osm: { name: 'OpenStreetMap', type: 'open', score: 60, freshness: 'Community map guidance' },
  geofabrik: { name: 'Geofabrik OSM', type: 'open', score: 60, freshness: 'Community map extract' },
  overpass: { name: 'Overpass / OSM', type: 'open', score: 58, freshness: 'Open map query' },
  wikidata: { name: 'Wikidata', type: 'open', score: 56, freshness: 'Reference guidance' },
  wikipedia: { name: 'Wikipedia / Commons', type: 'open', score: 54, freshness: 'Reference guidance' },
  openbeta: { name: 'OpenBeta', type: 'open', score: 62, freshness: 'Climbing guidance' },
  viator: { name: 'Viator', type: 'commercial', score: 68, freshness: 'Experience partner' },
  mapbox: { name: 'Mapbox', type: 'commercial', score: 72, freshness: 'Place search' },
