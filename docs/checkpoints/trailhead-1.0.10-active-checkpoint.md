...
Active Welcome and first-run packet: [`welcome-first-run-active-checkpoint.md`](./welcome-first-run-active-checkpoint.md). Read it before changing onboarding artwork, setup behavior, or the Profile walkthrough.
